...
<body>
    ...
    <form action="prosesEdit.php" method = "post">
        ...
        <table>
                ...
                <td><input type="text" name = "idp" placeholder = "ID Kepegawaian" 
                value="<?php echo $pegawai['id_pegawai'] ?> " ></td>
                </tr>
                <tr>
                <td><label for="iddpt">ID Departemen  </label></td>
                <td><input type="text" name = "iddpt" placeholder = "ID Departemen" 
                value="<?php echo $pegawai['id_departemen'] ?> " ></td>
                </tr>
                <tr>
                <td><label for="idkrj">ID Pekerjaan</label></td>
                <td><input type="text" name = "idkrj" placeholder = "ID Kerja" 
                value="<?php echo $pegawai['id_pekerjaan'] ?> " ></td>
                </tr>
                <tr>
                <td><label for="nama">Nama  </label></td>
                <td><input type="text" name = "nama" placeholder = "Nama Lengkap" 
                value="<?php echo $pegawai['nama_pgw'] ?>"></td>
                </tr>
                <tr>
                <td><label for="email">Email  </label></td>
                <td><input type="text" name = "email" placeholder = "Email" 
                value="<?php echo $pegawai['email_pgw'] ?>"></td>
                </tr>
                <tr>
                <td><label for="telp">No Telepon  </label></td>
                <td><input type="text" name = "telp" placeholder = "No Telepon" 
                value="<?php echo $pegawai['notelp_pgw'] ?>"></td>
                <tr>
